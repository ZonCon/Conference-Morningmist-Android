package com.megotechnologies.conference_morningmist.push;
...
import com.megotechnologies.conference_morningmist.ZonConApplication;
import com.megotechnologies.conference_morningmist.db.DbConnection;
import com.megotechnologies.conference_morningmist.loading.SplashActivity;
...
public class NotificationService extends Service {
										...
										if(recordsItems.size() == 0) {
											...
											if(dbC.isOpen()) {
												...
												if (recordsNotifs.size() == 0) {
													...
													map.put(MainActivity.DB_COL_SUB, title);
													msg.obj = map;
	...
	public void showNotification(String msg, String idStream) {
		...
		newIntent.putExtra("new-message", map);
	...
	public Handler notifHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			String title = map.get(MainActivity.DB_COL_SUB);
			String idStream = map.get(MainActivity.DB_COL_SRV_ID);
			showNotification(title, idStream);
